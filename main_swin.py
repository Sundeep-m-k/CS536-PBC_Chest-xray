    ...
    if args.resume:
        if args.resume.startswith('https'):
            checkpoint = torch.hub.load_state_dict_from_url(
                args.resume, map_location='https', check_hash=True)
        else:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('DETR with Swin Backbone - training and evaluation script', parents=[get_args_parser()])
